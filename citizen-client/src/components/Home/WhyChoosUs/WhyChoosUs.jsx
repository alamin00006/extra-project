...
const WhyChooseUs = () => {
  return (
    <div className="custom-container mb-10 h-[500px] bg-[#f4f6f9] relative ">
      <div className="grid grid-cols-1 md:grid-cols-12 w-full h-full gap-5 ">
        ...
        <div className="md:col-span-6 w-full h-full bg-[#2b7c7c] text-white">
