  ...
  return (
    <footer className="shadow-md">
      <div className="bg-[#e8ffff] text-[#565656] py-8 relative">
        {/* Watermark */}
        <div
          className="absolute md:top-12 sm:top-44 md:left-48 sm:left-0 md:h-full sm:h-[100px] opacity-20 md:w-[1000px] sm:w-[300px] md:rotate-0 sm:rotate-45"
          style={{
        ...
        <div className="custom-container mx-auto md:px-0 sm:px-5 flex flex-wrap justify-between items-start relative z-10">
          ...
          <div>
            ...
            <p className="mt-4">We are Committed to Serve, Care for Health.</p>
          </div>
