...
export const cardData = [
  ...
  },
  {
    ...
    content: (
      <div>
        <p className="text-base md:text-base mb-4 text-[#565656] leading-8 font-bengali">
          আমরা জানি, পরিবারের কেউ অসুস্থ হলে ঘর ছেড়ে ওষুধ আনা কতটা কষ্টের কাজ
          হয়ে দাঁড়ায়। বিশেষ করে বয়স্ক বাবা-মা বা ক্রনিক রোগে ভোগা
          প্রিয়জনদের জন্য জরুরি ওষুধ প্রয়োজন হলে দুশ্চিন্তা আরও বেড়ে যায়।
          এজন্যই আমরা, সিটিজেন কেয়ার বাংলাদেশ, আমাদের নিবন্ধিত মেম্বারদের
          প্রয়োজন অনুযায়ী এবং ডাক্তারের প্রেসক্রিপশন অনুযায়ী অথেনটিক
          দেশি-বিদেশি ওষুধ এবং মেডিকেল ইকুইপমেন্ট কোনো প্রকার ডেলিভারি চার্জ
          ছাড়াই সরাসরি আপনার বাড়ির দোরগোড়ায় পৌঁছে দিচ্ছি।
        </p>
        <p className="text-base md:text-base mb-4 text-[#565656] leading-8 font-bengali">
          আমাদের লক্ষ্য হচ্ছে আপনার প্রিয়জনের স্বাস্থ্য ব্যবস্থাপনাকে সহজতর করা
          এবং আপনাকে মানসিক শান্তি দেওয়া। আপনার প্রয়োজনীয় ওষুধ ঘরে বসেই
          নিশ্চিত করার মাধ্যমে হাসপাতালে দৌড়ানোর ঝামেলা থেকে আপনাকে মুক্ত
          রাখছি, যাতে আপনি প্রিয়জনের পাশে থাকতে পারেন আর তাদের সেবায় মনোযোগ
          দিতে পারেন।
        </p>
        <p className="text-base md:text-base mb-4 text-[#565656] leading-8 font-bengali">
          অথেনটিক এবং রেফ্রিজারেশন প্রয়োজনীয় ওষুধও আমরা নিরাপদে হোম ডেলিভারি
          করি। মেম্বার হবার পর আপনার দরকার হলে শুধুমাত্র আমাদের হেল্পলাইনে কল
          করুন, বাকিটা আমরা দেখব। সুস্থ জীবনের পথে আপনার বিশ্বস্ত সহযাত্রী হতে
          পেরে আমরা গর্বিত।
        </p>
      </div>
    ),
